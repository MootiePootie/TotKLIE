...
namespace ToTKLIE
{
    ...
    {
        public static Dictionary<string, string> ArmorDictionary = new Dictionary<string, string>()
        {
        ...
        public static Dictionary<string, string> BowDictionary = new Dictionary<string, string>()
        {
        ...
        public static Dictionary<string, string> ArrowDictionary = new Dictionary<string, string>()
        {
            {"NormalArrow","Arrow"}
        };


        public static Dictionary<string, string> ShieldDictionary = new Dictionary<string, string>()
        {
        ...
        public static Dictionary<string, string> WeaponDictionary = new Dictionary<string, string>()
        {
        ...
        public static Dictionary<string, string> MaterialsDictionary = new Dictionary<string, string>()
        {
            {"Item_Fruit_A","Apple"},
        ...
        public static Dictionary<string, string> FoodDictionary = new Dictionary<string, string>() 
        {
        ...
        public static Dictionary<string, string> ZonaiDictionary = new Dictionary<string, string>() 
        {
        ...
        public static Dictionary<string, string> ModifierDictionary = new Dictionary<string, string>()
        {
            {"B6EEDE09","None" },
            {"A9384C6C","Attack Up" },
            {"DAD10617","Attack Up x2" },
            {"D5CAD39B","Durability Up" },
            {"B2C943EE","Durability Up x2" },
            {"D0EFAC53","Critical Up" },
            {"9659C804","Long Throw" },
            {"7D505BC4","Quick Shot" },
            //{"54535B3C","Arrow x3" },
            {"934069CD","Arrow x5" },
            {"37EAE30F","Block Up" },
            {"0B3C94E5","Block Up x2" },
        };
        ...
        {
            {"B6EEDE09","None" },
            {"1DF7A011","Heat Resistance" },
            {"11383AFD","Flame Guard" },
            {"9B6D98FB","Cold Resistance" },
            {"183CD822","Shock Resistance" },
            {"25293142","Lightning Proof" },
            {"F5E2A20C","UnFreezable" },
            //{"C45B507D","Resistancient" },
            {"67866C6D","Swim Speed Up" },
            {"87645022","Swimg Dash Stamina Up" },
            //{"0FE3EA37","Spin Attack" },
            //{"E5943C0B","ClimbWaterFall" },
            {"DC7FAF6E","Climb Speed Up" },
            //{"1DF7A011","Horizontal Climb Speed Up" },
            {"A9384C6C","Attack Up" },
            {"4A3E58F6","Cold Weather Attack Up" },
            {"4C6A85D2","Hot Weather Attack Up" },
            {"FF347A38","Stormy Weather Attack Up" },
            //{"04C85996","Dark Attack Up" },
            //{"B6EEDE09","Atack Up Bone" },
            {"74141898","Stealth Up" },
            {"9ADD92A3","Sand Speed Up" },
            {"33261E44","Snow Speed Up" },
            //{"EE43C9B2","WakeWind" },
            //{"53ACEFD0","TwiceJump" },
            //{"04C85996","EmergencyAvoid" },
            {"A0A00C0E","Defense Up" },
            {"B3F6B87A","Speed Up" },
            {"4D1E8AF4","Gloom Resistance" },
            //{"9B6D98FB","MaskBokoblin" },
            //{"EE43C9B2","MaskMoriblin" },
            //{"53ACEFD0","MaskLizalfos" },
            //{"04C85996","MaskLynel" },
            //{"B6EEDE09","YigaMask" },
            //{"1DF7A011","StalDisguise" },
            //{"11383AFD","LifeRecover" },
            {"C1DB0965","Extra Heart" },
            {"E9A30056","Stamina Recovery" },
            {"60D8315D","Extra Stamina" },
            {"03459853","Gloom Recovery" },
            {"6775F470","Skydive Mobility Up" },
            {"2B0CB1E9","Slip Resistance" },
            //{"53ACEFD0","Moisturizing" },
            {"4939DCA1","Glow" },
            {"CFD032DB","Rupee Padding" },
            //{"EE43C9B2","Fall Resist" },
            {"59BE2CC3","Master Sword Beam Up" },
            //{"04C85996","VisualizeLife" },
            {"82638F9D","Night Speed Up" },
            //{"EE43C9B2","NightGlow" },
            {"0D1D9EF3","Climbing Jump Stamina Up" },
            {"48AA5DDF","Charge Attack Stamina Up" },
            //{"9B6D98FB","Emitterror" },
            {"2F3B7069","Fire Proof" },
            {"C5DEF427","Impact Proof" },
            {"346A7ABC","Slip Proof" },
            //{"9B6D98FB","RupeeGuardRate" },
            //{"EE43C9B2","MaskAll" },
            {"A3B0355E","Energy Up" },
            {"52FAD704","Energy Recharge Up" },
            //{"9B6D98FB","MaskHorablin" },
            {"671DBE0D","Gloom Attack Resist" },
            {"F563B129","Cold Weather Charge" },
            {"4FB7ED09","Hot Weather Charge" },
            {"8F4FDAF4","Stormy Weather Charge" },
            {"1D249847","Shining Steps" },
            //{"53ACEFD0","SoulPowerUpLightning" },
            //{"53ACEFD0","SoulPowerUpWater" },
            //{"53ACEFD0","SoulPowerUpWind" },
            //{"53ACEFD0","SoulPowerUpFire" },
            //{"53ACEFD0","SoulPowerUpSpirit" },
            //{"53ACEFD0","EnableUsesSwordBeam" },


        };

        public static Dictionary<string, string> DyeDictionary = new Dictionary<string, string>()
        {
            {"B6EEDE09","None" },
            {"E2911ABA","Blue" },
            {"6E1A9181","Red" },
